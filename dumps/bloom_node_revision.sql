...
CREATE TABLE `node_revision` (
  ...
  KEY `uid` (`uid`),
  KEY `vuuid` (`vuuid`)
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8 COMMENT='Stores information about each saved version of a node.';
...
-- Dump completed on 2014-07-02 20:40:14
