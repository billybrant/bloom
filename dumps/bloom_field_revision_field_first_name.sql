...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 15 (field_first_name)';
...
INSERT INTO `field_revision_field_first_name` VALUES ('node','hipaa_pii',0,50,52,'und',0,'William',NULL),('node','hipaa_pii',0,51,53,'und',0,'William',NULL),('node','hipaa_pii',0,52,54,'und',0,'William ',NULL),('node','hipaa_pii',0,53,55,'und',0,'William',NULL);
