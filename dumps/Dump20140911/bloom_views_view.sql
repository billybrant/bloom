...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='Stores the general data for a view.';
...
INSERT INTO `views_view` VALUES (1,'weighty_person','','default','node','Weighty Person',7),(2,'pii','','default','node','pii',7),(3,'not_pii','','default','node','not pii',7),(4,'icd_9_drupal_title_values','','default','taxonomy_term_data','ICD-9 Drupal Title Values',7),(5,'pii_view','HIPAA Protected Personal Identifying Information','default','node','PII',7);
