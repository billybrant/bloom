...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 16 (field_last_name)';
...
INSERT INTO `field_data_field_last_name` VALUES ('node','hipaa_pii',0,50,52,'und',0,'Goedicke',NULL),('node','hipaa_pii',0,51,53,'und',0,'Goedicke',NULL),('node','hipaa_pii',0,52,54,'und',0,'Smith',NULL),('node','hipaa_pii',0,53,55,'und',0,'Goedicke',NULL);
